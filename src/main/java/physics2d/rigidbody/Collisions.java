...
public class Collisions {
    ...
    public static CollisionManifold findCollisionFeatures(Collider2D c1, Collider2D c2) {
        ...
        if (c1 instanceof Circle && c2 instanceof Circle) return findCollisionFeatures((Circle)c1, (Circle)c2);
        else assert false : "Unknown collider '" + c1.getClass() + "' vs '" + c2.getClass() + "'";
    ...
    public static CollisionManifold findCollisionFeatures(Circle a, Circle b) {
        ...
        if (distance.lengthSquared() - (sumRadii * sumRadii) > 0) return result;
